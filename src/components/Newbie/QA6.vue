      ...
      <div class="question-wrapper">
        ...
        <div class="symbols show">
          <span id="char0" class="list-complete-item"
            >What is "Pedestrian" in Chinese?</span
          >
        </div>
      </div>
    </section>
  ...
  computed: {
    handleBackground() {
      if (!this.ismobile()) {
        ...
        return {
          "background-image": `url(${require("../../assets/image/4121.Q4.CD.background.p.jpg")})`
        };
      }
    }
  },
    ...
    runTimer(me) {
      ...
      me.timer = setInterval(function() {
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q4.CD.option1.mp3"));
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q4.CD.option2.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[1] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q4.CD.option3.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[2] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q4.CD.option4.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[3] = true;
        }
        ...
        // Question Audio
        if (!me.questionAudio) {
          me.playAudio(require("../../assets/audio/Q4.CD.question.mp3"));
