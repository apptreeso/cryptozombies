    ...
    runTimer(me) {
      ...
      me.timer = setInterval(function() {
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q1.ABCD.option1.mp3"));
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q1.ABCD.option2.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[1] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q1.ABCD.option3.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[2] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q1.ABCD.option4.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[3] = true;
        }
        ...
        // Question Audio
        if (!me.questionAudio) {
          me.playAudio(require("../../assets/audio/Q1.ABCD.question.mp3"));
