    ...
    <section class="question" v-if="showQuestion">
      <div class="question-wrapper">
        ...
        <div class="symbols show">
          <span id="char0" class="list-complete-item">What is "Exit" in Chinese?</span>
        </div>
      </div>
    </section>
...
export default {
  ...
  computed: {
    handleBackground() {
      if (!this.ismobile()) {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q2.ABCD.background.l.jpg")})`
        };
      } else {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q2.ABCD.background.p.jpg")})`
        };
      }
    }
  },
  methods: {
    ...
    runTimer(me) {
      ...
      me.timer = setInterval(function() {
        ...
        if (
          me.limitSecond - parseInt(me.seconds) == 2 &&
          me.milliseconds == 0
        ) {
          me.showAnswer = true;
        }
        ...
        // Question Audio
        if (!me.questionAudio) {
          me.playAudio(require("../../assets/audio/Q2.ABCD.question.mp3"));
