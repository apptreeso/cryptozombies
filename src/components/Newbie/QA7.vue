      ...
      <div class="question-wrapper">
        ...
        <div class="symbols show">
          <span id="char0" class="list-complete-item"
            >What is "Next time" in Chinese?</span
          >
        </div>
      </div>
    </section>
...
export default {
  ...
  computed: {
    handleBackground() {
      if (!this.ismobile()) {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q5.BC.background.l.jpg")})`
        };
      } else {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q5.BC.background.p.jpg")})`
        };
      }
    }
  },
    ...
    runTimer(me) {
      ...
      me.timer = setInterval(function() {
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q5.BC.option1.mp3"));
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q5.BC.option2.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[1] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q5.BC.option3.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[2] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q5.BC.option4.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[3] = true;
        }
        ...
        // Question Audio
        if (!me.questionAudio) {
          me.playAudio(require("../../assets/audio/Q5.BC.question.mp3"));
