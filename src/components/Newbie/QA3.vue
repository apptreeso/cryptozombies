      ...
      <div class="question-wrapper">
        ...
        <div class="symbols show">
          <span id="char0" class="list-complete-item"
            >What is "Sidewalk" in Chinese?</span
          >
        </div>
      </div>
    </section>
...
export default {
  ...
  computed: {
    handleBackground() {
      if (!this.ismobile()) {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q3.ABC.background.l.jpg")})`
        };
      } else {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q3.ABC.background.p.jpg")})`
        };
      }
    }
  },
