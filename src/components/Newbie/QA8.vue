...
export default {
  ...
  computed: {
    handleBackground() {
      if (!this.ismobile()) {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q5.A.background.l.jpg")})`
        };
      } else {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q5.A.background.p.jpg")})`
        };
      }
    }
  },
    ...
    runTimer(me) {
      ...
      me.timer = setInterval(function() {
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q5.A.option1.mp3"));
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q5.A.option2.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[1] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q5.A.option3.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[2] = true;
        }
        if (
          me.limitSecond - parseInt(me.seconds) == 11 &&
          me.milliseconds == 0
        ) {
          me.playAudio(require("../../assets/audio/Q5.A.option4.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[3] = true;
        }
