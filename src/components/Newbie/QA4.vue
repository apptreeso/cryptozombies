...
export default {
  ...
  computed: {
    handleBackgroundHeight() {
      if (!this.ismobile()) {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q3.D.background.l.jpg")})`
        };
      } else {
        return {
          "background-image": `url(${require("../../assets/image/4121.Q3.D.background.p.jpg")})`
        };
      }
    }
  },
    ...
    runTimer(me) {
      ...
      me.timer = setInterval(function() {
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q3.D.option1.mp3"));
        ...
        if (
          ...
          me.playAudio(require("../../assets/audio/Q3.D.option2.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[1] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q3.D.option3.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[2] = true;
        }
        if (
          ...
          me.playAudio(require("../../assets/audio/Q3.D.option4.mp3"));
          me.isActive = [false, false, false, false];
          me.isActive[3] = true;
        }
        ...
        // Question Audio
        if (!me.questionAudio) {
          me.playAudio(require("../../assets/audio/Q3.D.question.mp3"));
